  ...
  return (
    <>
      <div className="container p-10">
        ...
        <p className="mb-3 font-roboto-condensed">Last updated: November 29, 2024</p>
        <p className="text-lg">
          This Privacy Policy describes Our policies and procedures on the
          collection, use and disclosure of Your information when You use the
          Service and tells You about Your privacy rights and how the law
          protects You. We use Your Personal data to provide and improve the Service. By using
          the Service, You agree to the collection and use of information in
          accordance with this Privacy Policy.
        </p>
        <h2 className="mt-4 text-4xl font-bold">Interpretation and Definitions</h2>
        <h3 className="text-2xl font-semibold underline mt-2">Interpretation</h3>
        <p className="text-lg">
        ...
        <h3 className="text-2xl font-semibold underline">Definitions</h3>
        ...
        <ul className="text-xl leading-10">
          ...
          <li className="before:content-['•']">
            <span>
              ...
              in this Agreement) refers to SaaHas.
            </span>
          </li>
          <li className="before:content-['•']">
            <span>
